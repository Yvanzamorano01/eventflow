...
<div class="container">
    ...
    <form action="{{ route('events.store') }}" method="POST">
        ...
        <div id="ticket-types">
            ...
            <div class="form-group">
                <label for="ticket_types[0][quantity]">Ticket Quantity</label>
                <input type="number" class="form-control" id="ticket_types[0][quantity]" name="ticket_types[0][quantity]" required>
            </div>
            <div class="form-group">
...
document.getElementById('add-ticket-type').addEventListener('click', function() {
    ...
    const index = ticketTypesDiv.querySelectorAll('.form-group').length / 3;
    const newTicketType = `
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="ticket_types[${index}][quantity]">Ticket Quantity</label>
            <input type="number" class="form-control" id="ticket_types[${index}][quantity]" name="ticket_types[${index}][quantity]" required>
        </div>
        <div class="form-group">
